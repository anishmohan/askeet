...
abstract class BaseRelevancyPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'AnswerId', 'Score', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (RelevancyPeer::ID, RelevancyPeer::USER_ID, RelevancyPeer::ANSWER_ID, RelevancyPeer::SCORE, RelevancyPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'answer_id', 'score', 'created_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'AnswerId' => 2, 'Score' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (RelevancyPeer::ID => 0, RelevancyPeer::USER_ID => 1, RelevancyPeer::ANSWER_ID => 2, RelevancyPeer::SCORE => 3, RelevancyPeer::CREATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'answer_id' => 2, 'score' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RelevancyPeer::ID);
	...
	const COUNT = 'COUNT(relevancy.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT relevancy.ID)';
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		AnswerPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + AnswerPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getAnswer(); 				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(RelevancyPeer::ID);
			$selectCriteria->add(RelevancyPeer::ID, $criteria->remove(RelevancyPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(RelevancyPeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(RelevancyPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(RelevancyPeer::ID, $pks, Criteria::IN);
			$objs = RelevancyPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
