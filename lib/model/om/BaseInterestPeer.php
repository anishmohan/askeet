...
abstract class BaseInterestPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (InterestPeer::ID, InterestPeer::USER_ID, InterestPeer::QUESTION_ID, InterestPeer::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (InterestPeer::ID => 0, InterestPeer::USER_ID => 1, InterestPeer::QUESTION_ID => 2, InterestPeer::CREATED_AT => 3, ),
	...
	const COUNT = 'COUNT(interest.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT interest.ID)';
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(InterestPeer::ID); 
