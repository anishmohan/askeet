...
abstract class BaseRelevancy extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RelevancyPeer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->score = $rs->getString($startcol + 3);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RelevancyPeer::ID)) $criteria->add(RelevancyPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RelevancyPeer::ID, $this->id);
