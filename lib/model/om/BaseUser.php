...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	public function getAnswersJoinAnswerRelatedByAnswerId($criteria = null, $con = null)
	{
				if ($criteria === null) {
			$criteria = new Criteria();
		}
		...
		if ($this->collAnswers === null) {
			if ($this->isNew()) {
				...
				$this->collAnswers = AnswerPeer::doSelectJoinAnswerRelatedByAnswerId($criteria, $con);
			}
		} else {
